...
admin_menu = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            ...
            InlineKeyboardButton(text="♻️Доход", callback_data="earned")
        ],
        [
...
done_menu = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="✅Готово", callback_data="back_admin")
        ]
    ]
)

# ======================== DONE MENU ========================
earned_menu = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="➕ Добавить", callback_data="earned:add"),
            InlineKeyboardButton(text="➖ Отнять", callback_data="earned:minus")
        ],
        [
            InlineKeyboardButton(text="🔁 Сбросить", callback_data="earned:reset")
        ],
        [
...
admin_settings_menu = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="💎Настроить канал", callback_data="edit_req_channel")
        ],
        [
